                   ...
                   <input type="hidden" name="user_id" id="user_id">
                    ...
                    <div class="form-group">
                        ...
                        <div class="col-sm-12">
                            ...
                            <input type="text" class="form-control" id="name" name="name" placeholder="Enter Name" value="" maxlength="50" required="" value="{{ $user->full_name }}">
    ...
    var table1 = $('.data-table').DataTable({
        ...
        columns: [
            ...
            {"data": null,
                ...
                "width": "4%",
                "render": function (o) {
                 return "<a href='javascript:void(0)' class='edituser' id = " +o.id  + " ><i class='fa-pencil-square-o'></i>Edit</a>";
                }
            },
            {"data": null,
                "searchable": false,
                ...
                "width": "4%",
                "render": function (o) {
                    return "<a href='javascript:void(0)' class='deluser' id = " + o.id  + " ><i class='fas fa-thumbs-up'></i>Delete</a>";
                }
            },
           ]
    });
