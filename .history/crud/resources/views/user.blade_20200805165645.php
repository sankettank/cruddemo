                   ...
                   <input type="hidden" name="user_id" id="user_id">
                    ...
                    <div class="form-group">
                        ...
                        <div class="col-sm-12">
                            ...
                            <input type="text" class="form-control" id="email" name="name" placeholder="Enter Name" value="" maxlength="50" required="">
...
<script type="text/javascript">
    $( document ).ready(function() {
     ...
     $('body').on('click', '.edituser', function () {
        ...
        $.get("{{ route('ajaxproducts.index') }}" +'/' + user_id +'/edit', function (data) {
